...
""", unsafe_allow_html=True)
    ...
    # Загрузка гифок
    with open("images/korgi.gif", "rb") as f:
        bot_gif = base64.b64encode(f.read()).decode("utf-8")
    with open("images/pes.gif", "rb") as f:
        ai_gif = base64.b64encode(f.read()).decode("utf-8")
...
""", unsafe_allow_html=True)
        ...
        <div style="margin-top: 20px; font-size: 14px; color: #fff; text-align: left;">
            <strong>🧑‍💻 Прыг-скок команда:</strong><br>
            &nbsp;&nbsp;&nbsp;&nbsp; Дмитрий Мальцев<br>
            &nbsp;&nbsp;&nbsp;&nbsp; Елена Штефан<br>
            &nbsp;&nbsp;&nbsp;&nbsp; 🍅 Анастасия Горбовцова<br>
            &nbsp;&nbsp;&nbsp;&nbsp; Арина Тарасова
        </div>
        """, unsafe_allow_html=True)
        ...
        <div style="margin-top: 20px; font-size: 12px; color: #aaa; text-align: center;">
            © 2025 Web-ChatBot<br>by Дмитрий красивый
        </div>
        """, unsafe_allow_html=True)

        with open("images/robot.gif", "rb") as f:
